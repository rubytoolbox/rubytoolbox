...
RSpec.describe GithubRepo, type: :model do
  ...
  describe "#total_issues_count_deprecated" do
    it "is nil if the repo has no data" do
      expect(described_class.new.total_issues_count_deprecated).to be_nil
    end
    ...
    it "is nil if the repo has issues disabled" do
      ...
      expect(repo.total_issues_count_deprecated).to be_nil
    end
    ...
    it "is the sum of issues if issues enabled and data available" do
      ...
      expect(repo.total_issues_count_deprecated).to be == 10 + 5
    end
  end

  describe "#issue_closure_rate_deprecated" do
    it "is nil if the repo has no data" do
      expect(described_class.new.issue_closure_rate_deprecated).to be_nil
    end

    it "is nil if the repo has data but issues are disabled" do
      expect(described_class.new(closed_issues_count: 10, open_issues_count: 5).issue_closure_rate_deprecated).to be_nil
    end

    it "is nil if the repo had no issues" do
      expect(described_class.new(closed_issues_count: 0, open_issues_count: 0).issue_closure_rate_deprecated).to be_nil
    end
    ...
    it "is the expected float if the repo has data" do
      ...
      expect(repo.issue_closure_rate_deprecated).to be == (10 * 100.0 / 15)
    end
  end

  describe "#pull_request_acceptance_rate_deprecated" do
    it "is nil if PR data is missing" do
      expect(described_class.new.pull_request_acceptance_rate_deprecated).to be_nil
    end
    ...
    it "is nil if the repo had no PRs" do
      ...
      expect(repo.pull_request_acceptance_rate_deprecated).to be_nil
    end
    ...
    it "is the expected float if the repo has PR data" do
      ...
      expect(repo.pull_request_acceptance_rate_deprecated).to be == (11 * 100.0) / (7 + 11 + 3)
    end
  end

  describe "#total_pull_requests_count_deprecated" do
    it "is nil if PR data is missing" do
      expect(described_class.new.total_pull_requests_count_deprecated).to be_nil
    end
    ...
    it "is the sum of open, closed and merged PRs" do
      ...
      expect(repo.total_pull_requests_count_deprecated).to be == 7 + 11 + 3
    end
  end
